...
deno_core::extension!(deno_fs_events, ops = [op_fs_events_open, op_fs_events_poll],);
...
#[op2]
#[smi]
fn op_fs_events_open(state: &mut OpState, #[serde] args: OpenArgs) -> Result<ResourceId, AnyError> {
