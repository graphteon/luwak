...
#[op2(fast)]
#[smi]
fn op_signal_bind(state: &mut OpState, #[string] sig: &str) -> Result<ResourceId, AnyError> {
...
#[op2(fast)]
pub fn op_signal_unbind(state: &mut OpState, #[smi] rid: ResourceId) -> Result<(), AnyError> {
